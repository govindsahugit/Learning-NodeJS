...
app.get(
  ...
  passport.authenticate("google", {
    failureRedirect:
      "http://localhost:5500/client/callback.html?error=something went wrong",
    session: false,
  }),
  async (req, res) => {
...
// Generating AuthUrl and Redirect
...
//   if (!code) {
//     res.redirect(`http://localhost:5500/client/callback.html?error=something went wrong`);
//     return res.end();
//   }
